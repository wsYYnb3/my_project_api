...
function initModels(sequelize) {
  ...
  productpriceincurrency.belongsTo(currency, {
    as: "currency",
    foreignKey: "currency_id",
  });
  currency.hasMany(productpriceincurrency, {
  ...
  useractivity.belongsTo(customer, {
    as: "customer",
    foreignKey: "customer_id",
  });
  customer.hasMany(useractivity, {
    as: "useractivities",
    foreignKey: "customer_id",
  });
  wishlistitem.belongsTo(customer, {
    as: "customer",
    foreignKey: "customer_id",
  });
  customer.hasMany(wishlistitem, {
    as: "wishlistitems",
    foreignKey: "customer_id",
  });
  ...
  productcartimage.belongsTo(product, {
    as: "product",
    foreignKey: "product_id",
  });
  product.hasMany(productcartimage, {
    as: "productcartimages",
    foreignKey: "product_id",
  });
  ...
  productpriceincurrency.belongsTo(product, {
    as: "product",
    foreignKey: "product_id",
  });
  product.hasMany(productpriceincurrency, {
    as: "productpriceincurrencies",
    foreignKey: "product_id",
  });
  ...
  technicalinformation.belongsTo(product, {
    as: "product",
    foreignKey: "product_id",
  });
  product.hasMany(technicalinformation, {
  ...
  category.belongsTo(translation, {
  ...
  translation.hasMany(category, {
    as: "slug_key_categories",
    foreignKey: "slug_key",
  });
  keyword.belongsTo(translation, {
    as: "keyword_key_translation",
    foreignKey: "keyword_key",
    targetKey: "translation_key",
  });
  translation.hasMany(keyword, { as: "keywords", foreignKey: "keyword_key" });
  page.belongsTo(translation, {
    as: "name_key_translation",
    foreignKey: "name_key",
  });
  ...
  pagecontent.belongsTo(translation, {
    as: "content_key_translation",
    foreignKey: "content_key",
  });
  translation.hasMany(pagecontent, {
    as: "pagecontents",
    foreignKey: "content_key",
  });
  product.belongsTo(translation, {
    as: "name_key_translation",
    foreignKey: "name_key",
    targetKey: "translation_key",
  });
  ...
  translation.hasMany(product, {
    as: "slug_key_products",
    foreignKey: "slug_key",
  });
  product.belongsTo(translation, {
    as: "origin_key_translation",
    foreignKey: "origin_key",
    targetKey: "translation_key",
  });
  translation.hasMany(product, {
    as: "origin_key_products",
    foreignKey: "origin_key",
  });
  product.belongsTo(translation, {
  ...
  translation.hasMany(product, {
    as: "description_key_products",
    foreignKey: "description_key",
  });
  productspecification.belongsTo(translation, {
    as: "content_key_translation",
    foreignKey: "content_key",
    targetKey: "translation_key",
  });
  translation.hasMany(productspecification, {
    as: "productspecifications",
    foreignKey: "content_key",
  });
  technicalinformation.belongsTo(translation, {
    as: "info_key_translation",
    foreignKey: "info_key",
    targetKey: "translation_key",
  });
